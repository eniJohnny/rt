...
use super::{brick::Brick, custom_composed::CustomComposed, helix::Helix, mobius::Mobius, nagone::Nagone, obj::Obj, torusphere::Torusphere};
...
pub trait ComposedShape: Debug + Sync + Send {
    ...
    fn as_custom_composed(&self) -> Option<&CustomComposed> { None }
    ...
    fn as_custom_composed_mut(&mut self) -> Option<&mut CustomComposed> { None }
